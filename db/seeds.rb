...
drink_one = Drink.new(name: "Red Wine", alcohol: 14, category: cat_one, volume: 175)
...
drink_two = Drink.new(name: "Rosé Wine", alcohol: 11, category: cat_one, volume: 175)
...
drink_three = Drink.new(name: "White Wine", alcohol: 10, category: cat_one, volume: 175)
...
drink_four = Drink.new(name: "Champagne", alcohol: 12, category: cat_one, volume: 125)
...
drink_five = Drink.new(name: "Port", alcohol: 20, category: cat_one, volume: 75)
...
drink_six = Drink.new(name: "Small Beer", alcohol: 5, category: cat_two, volume: 200)
...
drink_seven = Drink.new(name: "Regular Beer", alcohol: 5, category: cat_two, volume: 330)
...
drink_eight = Drink.new(name: "Pint of Beer", alcohol: 5, category: cat_two, volume: 500)
...
drink_nine = Drink.new(name: "Craft", alcohol: 10, category: cat_two, volume: 330)
...
drink_ten = Drink.new(name: "Whiskey", alcohol: 40, category: cat_three, volume: 50)
...
drink_eleven = Drink.new(name: "Rum", alcohol: 40, category: cat_three, volume: 50)
...
drink_twelve = Drink.new(name: "Tequila", alcohol: 40, category: cat_three, volume: 50)
...
drink_thirteen = Drink.new(name: "Vodka", alcohol: 40, category: cat_three, volume: 50)
...
drink_fourteen = Drink.new(name: "Brandy", alcohol: 40, category: cat_three, volume: 50)
...
drink_fifteen = Drink.new(name: "Vermute", alcohol: 15, category: cat_three, volume: 60)
...
drink_sixteen = Drink.new(name: "Rum&Coke", alcohol: 12, category: cat_four, volume: 250)
...
drink_seventeen = Drink.new(name: "Vodka&Juice", alcohol: 12, category: cat_four, volume: 250)
...
drink_eighteen = Drink.new(name: "Gin&Tonic", alcohol: 13, category: cat_four, volume: 250)
file = URI.open('https://res.cloudinary.com/dqwh6jkno/image/upload/v1670314504/Gin_Tonic_cainn2.png')
...
drink_twenty = Drink.new(name: "Mojito", alcohol: 13, category: cat_four, volume: 250)
...
drink_twenty_one = Drink.new(name: "Caipirinha", alcohol: 15, category: cat_four, volume: 250)
...
drink_twenty_two = Drink.new(name: "Margarita", alcohol: 30, category: cat_four, volume: 200)
...
drink_twenty_three = Drink.new(name: "Bloody Mary", alcohol: 25, category: cat_four, volume: 200)
...
drink_twenty_four = Drink.new(name: "Negroni", alcohol: 24, category: cat_four, volume: 200)
...
drink_twenty_five = Drink.new(name: "Small Cyder", alcohol: 4, category: cat_five, volume: 200)
...
drink_twenty_six = Drink.new(name: "Regular Cyder", alcohol: 4, category: cat_five, volume: 330)
...
drink_twenty_seven = Drink.new(name: "Pint of Cyder", alcohol: 4, category: cat_five, volume: 500)
...
drink_twenty_eight = Drink.new(name: "Whisky Shot", alcohol: 40, category: cat_six, volume: 50)
...
drink_twenty_nine = Drink.new(name: "Tequilla Shot", alcohol: 40, category: cat_six, volume: 50)
file = URI.open('https://res.cloudinary.com/dqwh6jkno/image/upload/v1670314506/Shot_Tequilla_avgebu.png')
drink_twenty_nine.photo.attach(io: file, filename: "", content_type: 'image/png')
drink_twenty_nine.save!

drink_thirty = Drink.new(name: "Vodka Shot", alcohol: 40, category: cat_six, volume: 50)
file = URI.open('https://res.cloudinary.com/dqwh6jkno/image/upload/v1670314506/Shot_Vodka_gufour.png')
drink_thirty.photo.attach(io: file, filename: "", content_type: 'image/png')
drink_thirty.save!

drink_thirty_one = Drink.new(name: "Rum Shot", alcohol: 40, category: cat_six, volume: 50)
...
drink_thirty_two = Drink.new(name: "Brandy Shot", alcohol: 40, category: cat_six, volume: 50)
